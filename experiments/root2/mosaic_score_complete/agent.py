...
root_agent = SequentialAgent(
    ...
    1. Get the founder background score using 'founder_background_score'.
    2. Gather evaluation scores using 'startup_evaluation_agent'.
    3. Format the evaluation scores using 'format_agent2'.
    4. Combine the founder background score with the evaluation scores.
    5. Return the final structured evaluation scores.
    """,
    sub_agents=[startup_evaluation_agent, format_agent2, founder_background_score],
