...
import { Card, BarChart, GoogleColors } from './components';
          ...
          <div className="mt-4">
            <div className="flex items-center justify-between mb-2">
              <p className="text-lg font-semibold">
                {data.growthMomentumData[1].value} <span className="text-xs font-normal text-gray-500">/ 1000</span>
              </p>
              <p className="text-sm text-gray-500">1y</p>
            </div>
            <div className="h-48">
              <BarChart data={data.growthMomentumData} color={GoogleColors.blue} />
            </div>
          </div>
        </Card>
        <Card>
          ...
          <div className="mt-4">
            <div className="flex items-center justify-between mb-2">
              <p className="text-lg font-semibold">
                {data.financialStrengthData[1].value} <span className="text-xs font-normal text-gray-500">/ 1000</span>
              </p>
              <p className="text-sm text-gray-500">1y</p>
            </div>
            <div className="h-48">
              <BarChart data={data.financialStrengthData} color={GoogleColors.blue} />
            </div>
          </div>
        </Card>
      </div>
