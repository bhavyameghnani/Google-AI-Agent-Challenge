...
export TRIGGER_NAME="main-records-trigger" # ---- Change trigger name
...
export SERVICE_NAME="main-records-service-vs1" # ---- Change service name
export ROOT_DIR="document_upload_service" # ---- Change name
