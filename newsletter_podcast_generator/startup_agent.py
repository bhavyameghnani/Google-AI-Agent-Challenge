...
class StartupInsight(BaseModel):
    ...
    category: str = Field(
        description="Category: Overview, Products, News, Funding, Hiring, Competition"
    )
...
class StartupAnalysisReport(BaseModel):
    ...
    company_overview: StartupInsight = Field(
    ...
    investment_highlights: List[str] = Field(
        description="Key investment points", default=[]
    )
...
class PDFParsedContent(BaseModel):
    ...
    document_type: str = Field(
        description="Type: pitch deck, report, financial statement, etc."
    )
...
CONTENT STRUCTURE:
1. Introduction (20 sec) - Hook and context
2. Company Overview (40-50 secs) - What they do, founding story
3. Products & Recent Launches (40 sec) - Key offerings and innovations
4. Recent News & Developments (40 sec) - Latest updates
5. Funding & Team (40 sec) - Financial health and team growth
6. Conclusion (30 sec) - Summary and call to action
