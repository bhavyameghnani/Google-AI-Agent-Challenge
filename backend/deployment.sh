...
export TRIGGER_NAME="main-founder-data-analyzer-trigger" # ---- Change trigger name
...
export SERVICE_NAME="main-founder-data-analyzer-service-vs1" # ---- Change service name
export ROOT_DIR="backend"
